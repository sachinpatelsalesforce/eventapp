    ...
    return (
      <div>
        ...
        <div className="max-w-md mx-auto px-4 py-16 text-center">
          ...
          <p className="text-white/50 mb-2">Thanks for helping us improve.</p>
          <p className="text-sm text-[#5EB3FF] font-medium mb-8">Your Feedback Form passport stamp has been awarded! 🎉</p>
      ...
      <div className="max-w-md mx-auto px-4 py-6">
        {!contactId ? (
          <Card className="p-6 text-center">
            <p className="text-white/50 mb-4">Register first to leave feedback</p>
